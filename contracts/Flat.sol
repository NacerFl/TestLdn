...
contract NODERewardManagement {
    ...
    constructor(
        ...
        rewardPerNode = _rewardPerNode * (10**17);
...
contract LoadedNodesTest is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;

    NODERewardManagement public nodeRewardManager;

    IJoeRouter02 public uniswapV2Router;
    IMeerkatRouter02 public uniswapV2Router2;
    ...
    constructor(
        ...
        IMeerkatRouter02 _uniswapV2Router2 = IMeerkatRouter02(uniV2Router);

        address _uniswapV2Pair = IMeerkatFactory(_uniswapV2Router2.factory())
